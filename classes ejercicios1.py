#!/usr/bin/python# -*- coding: utf-8 -*-class Producto:  
# """ Ejemplo de clase con la cantidad y el precio de un pro-ducto"""  


class Producto:  """ Ejemplo de clase con la cantidad y el precio de un pro-ducto"""  
...
print (mi_producto2.unidades) (mi_producto2.agrega(5))
print (mi_producto2.unidadesmi_producto2.informe())